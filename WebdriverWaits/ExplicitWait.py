"""
Automate facebook page using Explicit Wait
Use Expected Conditions and WebDriverWait Class
"""
...
# import webdriver wait and expected conditions
...
class ExplicitExample(Data, Locators):
    def __init__(self):
...
if __name__ == "__main__":
    myexplicit = ExplicitExample()
    myexplicit.launch_facebook()